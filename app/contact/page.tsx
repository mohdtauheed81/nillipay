...
export default function ContactPage() {
  ...
  return (
    <div className="bg-white pt-16 mt-4">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            {contactMethods.map((method, index) => (
              <div
                key={index}
                className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-2 text-center"
              >
            ...
            <div>
              ...
              <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-lg">
                ...
                <div className="flex space-x-4">
                  <a
                    href="#"
                    className="bg-blue-100 text-blue-600 w-12 h-12 rounded-lg flex items-center justify-center hover:bg-blue-600 hover:text-white transition-all"
                  >
                    <Linkedin className="w-6 h-6" />
                  </a>
                  <a
                    href="#"
                    className="bg-blue-100 text-blue-600 w-12 h-12 rounded-lg flex items-center justify-center hover:bg-blue-400 hover:text-white transition-all"
                  >
                    <Twitter className="w-6 h-6" />
                  </a>
                  <a
                    href="#"
                    className="bg-blue-100 text-blue-600 w-12 h-12 rounded-lg flex items-center justify-center hover:bg-blue-700 hover:text-white transition-all"
                  >
                    <Facebook className="w-6 h-6" />
                  </a>
                  <a
                    href="#"
                    className="bg-blue-100 text-blue-600 w-12 h-12 rounded-lg flex items-center justify-center hover:bg-pink-600 hover:text-white transition-all"
                  >
